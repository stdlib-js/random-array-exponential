...
```javascript
import exponential from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-exponential@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-exponential/tags). For example,

```javascript
import exponential from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-exponential@v0.2.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-exponential@esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-array-exponential.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-array-exponential

[test-image]: https://github.com/stdlib-js/random-array-exponential/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/random-array-exponential/actions/workflows/test.yml?query=branch:v0.2.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-array-exponential/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-array-exponential?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-exponential.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-exponential/main
...
[deno-url]: https://github.com/stdlib-js/random-array-exponential/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-array-exponential/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-array-exponential/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-array-exponential/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-array-exponential/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-array-exponential/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-array-exponential/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-array-exponential/main/LICENSE
